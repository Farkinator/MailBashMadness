...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("HaxeFlixel", "MailBashMadness", "com.example.myapp", "0.0.1");
		...
		telemetryConfig.app_name = "MailBashMadness";
		#end
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "MailBashMadness", null, { width: 1024, height: 768 });
